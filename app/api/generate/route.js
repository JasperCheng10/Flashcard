...
Your task is to generate concise and effective flashcards based on the given topic or content. 
Follow these guidelines

1. Create clear and concise questions for the front of the flashcard.
2. Provide accurate and informative answers for the back of the flashcard.
3. Ensure that eac flashcard focuses on a single concept or piece of information.
...
export async function POST(req) {
  ...
  const completion = await openai.chat.comletion.create({
    messages: [
